        ...
        <li>
            <a href="{{ route('article.show', [$article->category->slug, $article->slug]) }}" class="group">
                ...
                <div class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                    <span class="font-medium text-red-500">{{ views($article)->unique()->count() }} Views</span>
                </div>
            </a>
        </li>
        @empty
...
<div class="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md">
    ...
    <div class="mt-4 flex flex-wrap gap-2">
        ...
        <a href="{{ route('tag.show', $tag->slug) }}" class="px-3 py-1 bg-gray-200 text-gray-700 rounded-full text-sm font-medium transition-colors
